defmodule TierlistsWeb.UserControllerTest do
  use TierlistsWeb.ConnCase

  alias Tierlists.Accounts
  alias Tierlists.Accounts.User

  @create_attrs %{email: "some email", is_admin: true, is_mod: true, password_hash: "some password_hash", string: "some string"}
